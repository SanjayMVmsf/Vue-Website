...
export const DASHBOARD_TABLE_TH = ["Symbol", "open", "high", "low", "Price", "Volume", "Latest Trading Day", "Previous Close",
    "change", "Change Percent", "Actions"
]
...
export const DASHBOARD_CONTENT = {
    NODES: [
        { id: 'node1', x: 150, y: 100, label: 'View Dashboard for current market prices' },
        { id: 'node2', x: 600, y: 100, label: 'Check the stocks which you want to buy' },
        { id: 'node3', x: 600, y: 320, label: 'Checked out stocks are visible in portfolio' },
        { id: 'node4', x: 150, y: 320, label: 'Bought stocks are visible in stocks' }
    ],
    LINKS: [
...
export const SYMBOLS = ["AAPL", "MSFT", "GOOG", "AMZN", "TSLA", "NFLX"]
