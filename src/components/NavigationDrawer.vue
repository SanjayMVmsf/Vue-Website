<template>
  ...
  <v-navigation-drawer v-model="drawer" color="#0FA774">
    <v-sheet color="#0FA774" class="pa-4">
      <v-avatar class="mb-4" color="#fff" size="64" />
      <button
        type="button"
        class="close"
        color="#ffffff"
...
import { DASHBOARD_MENU, DASHBOARD_MENU_TEXT, USERNAME } from '../Commons/Constants.ts';
...
export default {
  ...
  methods: {
    ...
    handleListClick(text) {
      ...
      } else if (text === DASHBOARD_MENU_TEXT.CHARTS) {
