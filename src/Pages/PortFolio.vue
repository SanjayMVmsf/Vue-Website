<template>
  ...
  <div class="buttonDiv">
    <button type="button" class="button" @click="proceedItem" :disabled="this.checkedValues && this.checkedValues.length != 0 ? false : true">{{PROCEED}}</button>
    <button type="button" class="button" @click="backItem">{{BACK}}</button>
  </div>
...
import { BUTTONS, MESSAGES, LOCALSTORAGE } from '../Commons/Constants.ts';
